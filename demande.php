...
<body>
    <div class="padding20">
        <div class="loginform-in">
            <img src="images/Logo_UEFA_Euro_2024.png" style="width: 140px;margin: 10px;" />
            <h3 style="margin-top: 0;color:#FFF">Formulaire d'inscription</h1>
                ...
                <form action="addDemande.php" method="post">
                    <table class="tableauPronosForm"
                        style="margin: auto;margin-bottom: 20px;padding-bottom: 20px;padding-top: 20px;padding-left: 90px;padding-right: 90px;width: 830px;">
                        <tr>
                            <td style="width: 33%;text-align:right;">
                                <label for="i1" style="padding-right: 35px;">Nom*</label>
                            </td>
                            <td>
                                <input id="i1" name="required" type="text" value="" class="serverside-validation"
                                    size="24" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="i2" name="required_prenom" type="text" value="" class="serverside-validation"
                                    size="24" />
                        ...
                        <tr>
                            <td style="text-align:right;">
                                ...
                                <div>
                                    <label for="i3"
                                        style="padding-right: 35px;font-weight: lighter;font-size: 12px;">Identifiant de
                                        connexion</label>
                                </div>
                            </td>
                            <td>
                                <input id="i3" name="check-surnom" type="text" value="" class="serverside-validation"
                                    size="24" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="i4" name="Email-check" type="text" value="" class="serverside-validation"
                                    size="24" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="i5" name="number" type="text" value="" class="serverside-validation"
                                    size="24" />
                        ...
                        <tr>
                            <td style="text-align:right;">
                                ...
                                <div>
                                    <label for="payement"
                                        style="padding-right: 35px;font-weight: lighter;font-size: 12px;">Frais
                                        d'inscription : 20€</label>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align:right;vertical-align: top;padding-top: 8px;">
                                <label for="description" id="descriptionLabel"
                                    style="padding-right: 35px;">Citation</label>
                            </td>
                            <td>
                                <textarea name="description" id="description" style="resize:none" name="name" cols="30"
                                    rows="6" class="serverside-validation"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:right;">
                            ...
                            <td>
                                <button id="buttonValidationSubmit"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                                    Valider
                                </button>
                                <button type="reset" value="Annuler"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"
                                    id="buttonValidationReset">
                                    Effacer
                                </button>
                            </td>
                        </tr>
