<?php
	...
	WHERE playoffs.competition = $competition AND playoffs.id = $id_playoff
	ORDER BY name";
	...
	if ($result) {
		while ($row = mysqli_fetch_array($result )) 
		{
			...
			echo "
				<div class='playoff-item playoff-item-big'>				
						<div class='playoff-item-left'>	";	
						...
						if ($id_equipe_home == "") {
							...
							echo "<div class='playoff-item-left-joueur'>";
								...
								echo "<img src='$joueurs_home_image' class='playoff-item-joueur-img-content playoff-item-joueur-img-content-big'/>";
								echo "</div>";
							
								echo "<div class='playoff-item-left-joueur-title'>";
									echo "<div class='playoff-item-left-title'><a class='surnom-match surnom-match-big' href='profil.php?id=$joueurs_home_id_joueur'>$joueurs_home_surnom</a></div>";
			...
			echo "					
					...
					<div class='playoff-item-right playoff-background'>	";	
					...
					if ($id_equipe_ext == "") {
						...
						echo "<div class='playoff-item-right-joueur'>";
							...
							echo "<div class='playoff-item-left-joueur-title'>";
								echo "<div class='playoff-item-left-title'><a class='surnom-match surnom-match-big' href='profil.php?id=$joueurs_ext_id_joueur'>$joueurs_ext_surnom</a></div>";
								echo "<div class='playoff-item-left-sub-title'>". getClassementFromNumeric($classements_ext_rang)."</div>";
							echo "</div>";

							echo "<div class='playoff-item-joueur-img'>";
								echo "<img src='$joueurs_ext_image' class='playoff-item-joueur-img-content playoff-item-joueur-img-content-big' />";
							echo "</div>";
		...
		echo "				
					...
					<div class='playoff-match playoff-match-big'>		
						$name
					</div>
				</div>";
	...
	if ($find == false) {
		echo '<div class="noplayoffs">Les playoffs ne sont pas encore disponible.</div>';
	}


	echo "<div class='playoff-content playoff-content-pronos'>
			<div class='playoff-item playoff-item-pronos'>";
			...
			WHERE day=$day and competition=$competition AND $id_equipe_home != 0 AND reporte=0
