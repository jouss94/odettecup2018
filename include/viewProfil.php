<?php
	...
	<table class="TableMatch"> 
		...
		<td style="height:30px;">
			<span class="titreTableau">MATCHES</span>';
		...
		if ($idProfil == $id && $modifMatch == 1)
		{
			echo '
			<tr>
			<td class="sousTableau buttonRigth" id="modifierMatch">
				Modifier
			</tr>
			</td>
			';
		...
		<tr >
			<td style="padding: 0;" >
			  <div class="cadreTableau cadreTableauMatch">';
	...
	{	
		...
		if ($row["played"] == 1)
		{
			$point = $row["point"];
			if ($point == 0)
				$classTR = "classTREchec";
			if ($point == 1)
				$classTR = "classTRInverse";
			if ($point == 3)
				$classTR = "classTRCorrect";
			if ($point == 4)
				$classTR = "classTRCorrectPlus";
			if ($point == 7)
				$classTR = "classTRPerfect";
		}
		else if ($row["played"] == 0)
		{
				$classTR = "classTRNeutre";
		...
		echo '
		<table class="affPronosTableau">';
		echo '<tr class="affPronosLigne ', $classTR, '">';

			echo '<td style="width:10%" class="affPronosLogo">';
				echo '<img class="logoEquipe"  style="margin-top: 2px;margin-bottom: 2px;margin-left: 10px;" src="', utf8_encode_function($row["home_logo"]), '" />';
			echo '</td>';
			
			echo '<td style="width:26%" class="tdMatchLeft"> ';
				echo utf8_encode_function($row["home_name"]);
			echo '</td>';
			...
			echo '<td style="width:26%" class="tdMatchRight">';
				echo utf8_encode_function($row["away_name"]);
			echo '</td>';
			...
			echo '<td style="width:8%;text-align: center;font-size: 16px;font-weight: bold;">';
			if ($row["played"] == 1)
				{
					echo '+', $row["point"];
				}
...
/*
	echo '<table class="TableMatch"> 

		<tr style="background: rgba(0, 0, 0, 0.8);color: white;">
		<td style="height:30px;">
			<span class="titreTableau">BONUS</span>';
		...
		if ($idProfil == $id && $modifBonus == 1)
		{
						...
						echo '
			<tr>
			<td class="sousTableau buttonRigth" id="modifierBonus">
				Modifier
			</tr>
			</td>
			';
